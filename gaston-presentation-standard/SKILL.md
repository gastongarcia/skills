...
description: Estándar estratégico y tecnológico de Gastón García para la creación y auditoría de reportes interactivos de negocio y de inteligencia de clientes.
---
...
La comunicación debe sonar **honesta, constructiva, clara y basada en la realidad del cliente B2B y el profesional técnico**. Se prohíbe el uso de "humo corporativo" o diagnósticos de marketing digital agresivos.
...
2. **Reencuadre positivo y de oportunidad (Reframing):**
   ...
   * *Correcto:* "La base sólida de rendimiento nos da luz verde para enriquecer el contenido", "Los PDFs son la herramienta de trabajo diario en el sector; los enriqueceremos con llamados a la acción interactivos."
...
4. **Cierre sobrio y silencioso (Sin gritos):**
   ...
   * Usar colores grises atenuados (`var(--soft)` o `#54514a`) en lugar de colores chillones o tonos saturados para el texto final.

---

## 2. El Estándar Tecnológico y de Diseño (Tech & UX Stack)

Toda presentation es una **aplicación web interactiva responsiva**, no un conjunto de diapositivas estáticas.

### Requisitos Técnicos Obligatorios:

1. **Dualidad de Formato (Slides vs. Documento):**
   * El archivo HTML debe tener un controlador de estado de visualización en JavaScript (con las clases `body.mode-slides` and `body.mode-doc`).
...
3. **Gráficos Vectoriales Esculpidos (SVG Nativo):**
   * Se prohíbe terminantemente copiar y pegar capturas de pantalla grises u oscuras de herramientas analíticas externas.
...
4. **Paleta de Colores Premium y Sobria (Ejemplo de Marca):**
   * **Warm Cream** (Fondo principal de papel): `#faf8f5`
   * **Brand Accent** (Color corporativo de acento): `#e21a22`
   * **Ink** (Texto oscuro de alto contraste): `#1c1b18`
   * **Soft Gray** (Textos secundarios y atenuados): `#54514a`
   * **Success Green** (Aciertos y métricas de éxito): `#20734c`
...
- [ ] **¿Hay capturas de pantalla o imágenes incrustadas de herramientas analíticas?** Si se encuentran enlaces a capturas estáticas, proponer su reemplazo inmediato por gráficos SVG interactivos integrados en la hoja de estilos de la presentación.
...
- [ ] **¿Se usa lenguaje técnico invasivo?** Reemplazar términos como "rebote", "embudo de ventas", "conversiones rotas" por expresiones centradas en el negocio B2B y en la capacitación ("tiempo de lectura", "sesiones core", "portales de educación o academias internas").
